            ...
            <div class="container">
                <div class="thankyou__header">
                    <div class="thankyou__title">
                        THANK YOU FOR USING EAT.LK YOUR ORDER HAS BEEN PLACED
                    </div>
                    <div class="thankyou__subTitle">
                        Please do visit us again and recommend us to your friends.
                    </div>
                </div>
                <div class="orderTick">
                    <img src="../EAT.LK/images/25-259863_one-time-order-and-fast-proxy-delivery-blue.png" alt="">
                </div>
