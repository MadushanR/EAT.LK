...
<body>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <input type="radio" name="type" <?php if (isset($type) && $type=="Vegetarian") echo "checked";?>
            value="Vegetarian">
        <label for="contact_phone">Non-Vegetarian</label>
        <input type="radio" name="type" <?php if (isset($type) && $type=="Non-Vegetarian") echo "checked";?>
